...
(function (global, factory) {
	...
	Object.assign(Book.prototype, {
		...
		volume: function(degree)
		{
			...
			{
				this.currentPage.music.volume = degree/100;
			}
		},
	...
	Object.assign(Reader.prototype, {
		...
		reading: function(delta)
		{
			...
			requestAnimationFrame(()=>this.reading(delta + 0.02));
		},
		...
		roundedNameBox: function(degree)
		{
			...
			{
				this.nom.style.borderRadius = (window.innerWidth * 0.9 * (degree/100))+"px";
			}
		},
		...
		roundedDialogBox: function(degree)
		{
			...
			if(degree >= 0 && degree <= 10)
			{
				this.dialogBox.style.borderRadius = (window.innerWidth * 0.9 * (degree/100))+"px";
			}
		},
	...
	Object.assign(Screen.prototype, {
		...
		{
			if((object.type) && (object.type == "image" || object.type == "button" || object.type == "book" || object.type == "audio" || object.type == "reader"))
			{
	...
	exports.Audio = Audio;
	exports.Book = Book; //Replace and improved Scene
	exports.button = button; //-------Improved
	exports.Character = Character;//------Improved
	exports.gameIcon = gameIcon;
	exports.image = image; //----------Improved
	exports.Reader = Reader; //New - Help to read the book
	exports.Screen = Screen; // Replace both Panel and Game
	exports.TreeNode = TreeNode; //----New
