(function (global, factory) {
	...
	//-----------------------------------------SCENE--------------------------------------------
	var choiceEnabled = null, CONTINU = null, REALMAX = null, CLEANING = null, DISSOLVE = 0.0, BGDISSOLVE = 0.4, ENDING = null, ENDID = 0, soundBand = null, CANCEL = null;
	...
	Object.assign(Scene.prototype, {
		...
		addSaving: function(saved)
		{
			...
			CURRENT = this.current;
			//this.currentAudio = Audio(saved.value.currentAudio.url);
